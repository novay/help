<div class="row">
	...
	<div class="col-md-4 form-group">
		...
		{!! Form::select('kabupaten_id',[],null,['class'=>'form-control chain', 'data-next-chain'=>'kecamatan_id','disabled','id'=>'kabupaten_id']) !!}
	</div>
	<div class="col-md-4 form-group">
		{!! Form::label('kecamatan_id','Nama Kecamatan') !!}
		{!! Form::select('kecamatan_id',[],null,['class'=>'form-control','disabled','id'=>'kecamatan_id']) !!}
	</div>
...
<script id="appendScript">
	(function () {
		var readOnlyLength;
		$(document).on('change', '#kecamatan_id', function(e) {
